            ...
            <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
                ...
                <form onSubmit={onSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input value={description} onChange={(e)=> onChangeDescription(e.target.value)} className="w-full rounded-md border border-gray-300 px-3 py-2 focus:border-gray-900 focus:outline-none"/>
                    </div>
